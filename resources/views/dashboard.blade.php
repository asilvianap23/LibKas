...
@section('header')
    <h2 class="font-semibold text-3xl text-blue-700 dark:text-blue-300 leading-tight text-center">
        {{ __('Dashboard Kas') }}
    </h2>
@endsection
...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 shadow-2xl rounded-xl overflow-hidden">
                <div class="p-10">
                    <h1 class="text-5xl font-extrabold text-blue-800 dark:text-blue-200 text-center mb-8">
                        Dashboard Kas
                    </h1>

                    <!-- Total Kas -->
                    <div class="bg-blue-200 p-8 shadow-lg rounded-lg text-center transform hover:scale-105 transition-transform duration-300 mb-8">
                        <h2 class="text-3xl font-semibold text-gray-800">
                            <i class="fas fa-wallet text-blue-800 mr-2"></i> Total Kas
                        </h2>
                        <p class="text-6xl font-extrabold text-blue-900 mt-4">Rp {{ $totalKas }}</p>
                    </div>

                    <!-- Ringkasan Kas -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        <!-- Kas Masuk -->
                        <div class="bg-white dark:bg-gray-800 p-8 shadow-md rounded-lg transform hover:scale-105 hover:shadow-xl transition-transform duration-300 border-l-8 border-green-500">
                        ...
                        <!-- Kas Keluar -->
                        <div class="bg-white dark:bg-gray-800 p-8 shadow-md rounded-lg transform hover:scale-105 hover:shadow-xl transition-transform duration-300 border-l-8 border-red-500">
                            <h2 class="text-lg font-semibold text-gray-800">
                    ...
                    <!-- Tabel Transaksi -->
                    <div class="bg-gray-100 dark:bg-gray-800 p-8 shadow-lg rounded-xl">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white dark:bg-gray-800 border-collapse rounded-lg shadow-md">
